...
void World::seed_test_units() {
    ...
    create_unit({{-160.0f, -80.0f}}, {0, {24.0f, 24.0f}}, {96.0f}, {});
    create_unit({{-60.0f, 0.0f}}, {1, {24.0f, 24.0f}}, {96.0f}, {});
    create_unit({{60.0f, 70.0f}}, {2, {24.0f, 24.0f}}, {112.0f}, {});
    create_unit({{150.0f, -20.0f}}, {3, {24.0f, 24.0f}}, {112.0f}, {});
}
